...
parser.add_argument("--width", help='Width of game screen', type=int, default=100)
parser.add_argument("--height", help='Height of game screen', type=int, default=100)
parser.add_argument("--cell_size", help='Size of one cell', type=int, default=10)
parser.add_argument("--max_generations", help='Maximum amount of generations', type=int, default=100)
